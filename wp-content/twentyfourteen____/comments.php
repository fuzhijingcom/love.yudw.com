...
<?php if ( have_comments() ) : ?>
    <h3 id="comments"> <?php comments_number('网友', '现有1条', '现有%条' );?>评论</h3>
		...
		<?php else : ?>
			...
			<div id="author_info">
		    	...
		    	<div class="author_right">
					...
					<?php $faceID = mt_rand(1,12);?>
		    		<img src="<?php bloginfo('template_directory'); ?>/face/<?php echo $faceID; ?>.gif" alt="表情/头像" id="faceImg" onclick="TAB()" title="点击图片可更换（表情/头像）!"/>点击头像可更换！<input name="url" id="url" value="<?php echo $faceID; ?>" style="display:none;"/>
		    	</div>
		    </div>
