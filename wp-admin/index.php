...
if ( current_user_can( 'edit_posts' ) )
	$help .= '<p>' . __( '<strong>站点内容</strong> - Displays a summary of the content on your site and identifies which theme and version of WordPress you are using.' ) . '</p>';
...
$screen->set_help_sidebar(
	...
	'<p>' . __( '<a href="http://yudw.com/" target="_blank">玉帝网</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://yudw.com/" target="_blank">支持论坛</a>' ) . '</p>'
);
